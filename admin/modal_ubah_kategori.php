...
<html lang="en">
  <head>
    ...
    <title>EDIT DATA KATEGORI - ADMIN</title>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
            ...
            include "../konek.php";
            $datapst=mysqli_query($koneksi,"SELECT * from kategori_buku where id_kategori='$id_kategori'");
            ...
            <table class="table" cellpadding="10" align="center" style="width: 40%;background-color: #f2f2f2" >
              <tr>
                <th>Edit Data Kategori</th>
              </tr>
              <input type="hidden" name="id_kategori" value="<?php echo $d['id_kategori'];?>">
              <tr>
                <td><p align="left">Nama Kategori</p> <input type="text" class="form-control placeholder-no-fix" required name="nama_kategori" value="<?php echo $d['nama_kategori'];?>"></td>
              </tr>
              <tr align="center">
                <td>
                  <a href="tampil_data_kategori.php"><button class="btn btn-default" type="button">Cancel</button></a>
