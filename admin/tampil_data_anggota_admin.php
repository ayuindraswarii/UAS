            ...
            <div class="white-panel pn">
              ...
              <table class="table" cellpadding="10" border="1" align="center">
                ...
                <?php 
                  ...
                  ?>
                  <tr>
                    <td align="center"><?php echo $d['id_anggota']; ?></td>
                    <td><?php echo $d['nama_anggota']; ?></td>
                    <td><?php echo $d['alamat_anggota']; ?></td>
                    <td><?php echo $d['telp']; ?></td>
                    <td align="center">
                      <button class="btn-warning"><a href="modal_ubah_anggota.php?id_anggota=<?php echo $d['id_anggota'];?>"><i class="fa fa-edit"></i></a></button>
                      <button class="btn-danger"><a href="hapus_anggota.php?id_anggota=<?php echo $d['id_anggota'];?>"><i class="fa fa-trash-o"></i></a></button>
                    </td>
                  </tr>   
                  <?php  
                  }
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <input type="text" required name="nama_anggota" value="" placeholder="Nama Anggota" autocomplete="off" class="form-control placeholder-no-fix">
                            <br>
                            <input type="text" required name="alamat_anggota" value="" placeholder="Alamat Anggota" autocomplete="off" class="form-control placeholder-no-fix">
                            <br>
                            <input type="text" required name="telp" value="" placeholder="Telepon" autocomplete="off" class="form-control placeholder-no-fix">
                            <br>
                        </div>
